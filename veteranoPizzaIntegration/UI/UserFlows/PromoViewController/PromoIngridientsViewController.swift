//
//  PromoIngridientsViewController.swift
...
class PromoIngredientsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        currentPrice = Int(truncating: PriceFactory.shared.returnPromoValue(id: food.name) as NSNumber)
        setUpViews()
        setUpGesture()
        setUp()
    ...
    private func setUpViews() {
        ...
        mainView.layout {
            $0.size(.width(300/375*Size.width), .height(535/812*Size.heigth))
        ...
        foodImage.layout {
            $0.top.constraint(to: backButton, by: .centerY(0))
        ...
        foodName.layout {
            ...
            $0.size(.width(200/375*Size.width), .height(20/812*Size.heigth))
        }
        
        mainView.addSubview(foodDescription)
        foodDescription.layout {
            $0.constraint(to: mainView, by: .leading(15/375*Size.width))
            $0.top.constraint(to: foodName, by: .bottom(5/812*Size.heigth))
            $0.size(.width(280/375*Size.width), .height(70/812*Size.heigth))
        }
        
        mainView.addSubview(quantityLabel)
        quantityLabel.layout {
            $0.constraint(to: mainView, by: .leading(15/375*Size.width))
            $0.top.constraint(to: foodDescription, by: .bottom(30/812*Size.heigth))
        ...
        countLabel.layout {
            $0.centerX.constraint(to: mainView, by: .centerX(0))
            $0.bottom.constraint(to: stepper, by: .top(-5/812*Size.heigth))
        ...
        textView.layout {
            $0.centerX.constraint(to: mainView, by: .centerX(0))
            $0.top.constraint(to: stepper, by: .bottom(15/812*Size.heigth))
            $0.size(.width(276/375*Size.width), .height(50/812*Size.heigth))
        }
        
        mainView.addSubview(priceLabel)
        priceLabel.layout {
            $0.bottom.constraint(to: mainView, by: .bottom(-30/812*Size.heigth))
            $0.constraint(to: mainView, by: .leading(15/375*Size.width))
            $0.size(.width(80/375*Size.width), .height(20/812*Size.heigth))
        }
...
extension PromoIngredientsViewController: UIGestureRecognizerDelegate {
...
extension PromoIngredientsViewController: UITextViewDelegate {
