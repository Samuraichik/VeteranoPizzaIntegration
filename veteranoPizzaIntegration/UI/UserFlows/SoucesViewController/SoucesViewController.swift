...
class SoucesViewController: UIViewController{
    ...
    private lazy var foodTableView: UITableView = {
        ...
        SoucesTableViewCell.register(for: tableView)
        return tableView
    }()
    ...
    var foodName: String!
    var foodArr = VeteranoInfo.shared.getSoucesArr()
...
extension SoucesViewController: UITableViewDataSource, UITableViewDelegate{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return foodArr.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = SoucesTableViewCell.deque(for: tableView, indexPath: indexPath) else {
            return UITableViewCell()
        }
        let selectedFood = foodArr[indexPath.row]
        cell.buttonAction = { [self] in
            let ingredientsViewController = SoucesIngridientsViewController()
